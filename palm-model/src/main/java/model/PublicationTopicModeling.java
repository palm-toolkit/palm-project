...
@Entity( name = "publication_topicmodel" )
public class PublicationTopicModeling extends PersistableResource
{
//	@ElementCollection
//	@MapKeyColumn( name = "term" )
//	@Column( name = "weight" )
	// @CollectionTable( name = "publication_topicmodel_weight" )
//	Map<Interest, Double> termWeights;

	@ElementCollection
	@MapKeyColumn( name = "term" )
	@Column( name = "weight" )
	@CollectionTable( name = "publication_topicModel_weight_string" )
	...
	// relation
	@ManyToOne
	@JoinColumn( name = "publication_topicmodel_profile_id" )
	private PublicationTopicModelingProfile publicationTopicModelingProfile;
...
//	}
//
	// public PublicationTopicModeling addTermWeight( Interest term, double
	// weight )
//	{
//		if ( termWeights == null )
...
//	}
	...
	public PublicationTopicModeling addTermWeight( String term, double weight )
	{
	...
	public PublicationTopicModelingProfile getPublicationTopicModelingProfile()
	{
		return publicationTopicModelingProfile;
	}

	public void setPublicationTopicModelingProfile( PublicationTopicModelingProfile publicationTopicModelingProfile )
	{

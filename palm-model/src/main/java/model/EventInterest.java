...
public class EventInterest extends PersistableResource
{
	@ElementCollection
	@MapKeyColumn( name = "term" )
	@Column( name = "weight" )
	@CollectionTable( name = "event_term_weight" )
	Map<Interest, Double> termWeights;

	@ElementCollection
	@MapKeyColumn( name = "term" )
	@Column( name = "weight" )
	@CollectionTable( name = "event_term_weight_string" )
	...
	// relation
	@ManyToOne
	@JoinColumn( name = "event_interest_profile_id" )
	private EventInterestProfile eventInterestProfile;
	...
	public EventInterest addTermWeight( Interest term, double weight )
	{
		if ( termWeights == null )
	...
	public EventInterest addTermWeight( String term, double weight )
	{
	...
	public EventInterestProfile getEventInterestProfile()
	{
		return eventInterestProfile;
	}

	public void setEventInterestProfile( EventInterestProfile eventInterestProfile )
	{
		this.eventInterestProfile = eventInterestProfile;
	}
